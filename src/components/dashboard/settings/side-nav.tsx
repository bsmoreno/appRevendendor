...
const navItems = [
  {
    ...
    title: 'Personal',
    items: [
      { key: 'account', title: 'Profile', href: paths.dashboard.settings.account, icon: 'user-circle' },
    ...
    <div>
      ...
      >
        ...
        <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
          ...
          <div>
            <Typography variant="subtitle1">{user?.ds_Nome} {user?.ds_Sobrenome}</Typography>
            <Typography color="text.secondary" variant="caption">
              {user?.ds_Email}
            </Typography>
          </div>
