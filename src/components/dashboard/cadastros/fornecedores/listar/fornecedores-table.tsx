...
import { FornecedoresMenuTable } from './fornecedores-menu-table'; 
...
export function FornecedoresTable(): React.JSX.Element {
    ...
    return (
        ...
        >
            ...
            <Column dataField="nr_Fornecedor" caption='N° Fornecedor' alignment='center' allowFiltering={false} width={50} />
            ...
            <Column dataField="cd_IE" caption='RG/IE'  /> 
            <Column dataField="ds_RazaoSocial" caption='Razão Social' />
            <Column dataField="ds_NomeFantasia" caption='Nome Fantasia' /> 
            ...
            <Column
                ...
                fixedPosition='right'
                cellRender={(data) => {
                    return (<FornecedoresMenuTable params={data.data} />)
