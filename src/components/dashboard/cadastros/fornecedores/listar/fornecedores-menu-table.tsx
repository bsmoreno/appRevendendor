...
export interface FornecedoresMenuTableProps {
  params: any;
}
export function FornecedoresMenuTable({ params }: FornecedoresMenuTableProps): React.JSX.Element {
        ...
        <Stack direction={'column'} alignItems={'flex-start'}>
          ...
          <Stack width={'100%'}>
            <Button
              ...
              href={paths.dashboard.cadastros.fornecedores.editar(params.id_Fornecedor)}
              startIcon={<PenIcon />}
              sx={{
