...
import { FornecedoresEditarFromHooks } from './hooks/fornecedores-editar-hooks';
import MaskedInput from 'react-text-mask'
import { MagnifyingGlass as SearchIcon } from '@phosphor-icons/react';
import AutoCompleteCidades from '@/components/widgets/autocomplete/autocompletecidades';
export interface FornecedoresEditarFromProps {
    id_Fornecedor: string
}

export function FornecedoresEditarFrom({ id_Fornecedor }: FornecedoresEditarFromProps): React.JSX.Element {
    var {
        Controller,
        handleSubmit,
        handleCep,
        ...
        maskCpfCnpj,
        maskCep
    } = FornecedoresEditarFromHooks(id_Fornecedor);
                            ...
                            <Grid container spacing={2}>
                                <Grid md={2} xs={12} >
                                    <Controller
                                        ...
                                        name="nr_Fornecedor"
                                        render={({ field }) => (
                                            <FormControl error={Boolean(errors.nr_Fornecedor)} fullWidth>
                                                <InputLabel required>N° Fornecedor</InputLabel>
                                                <OutlinedInput disabled readOnly inputProps={{ style: { textAlign: 'center' } }} {...field} />
                                                {errors.nr_Fornecedor ? <FormHelperText>{errors.nr_Fornecedor.message}</FormHelperText> : null}
                                            </FormControl>
                                        )}
                                    />
                                </Grid>
                                            ...
                                            <Controller
                                                ...
                                                render={({ field }) => (
                                                    <FormControl error={Boolean(errors.tp_Status)} fullWidth>
                                                        ...
                                                        {errors.nr_Contato ? <FormHelperText>{errors.tp_Status.message}</FormHelperText> : null}
                                                    </FormControl>
                                                )}
                                            />
                                        </Grid>
