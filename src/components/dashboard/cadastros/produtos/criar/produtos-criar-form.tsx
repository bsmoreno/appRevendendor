...
import { ClientesCriarFromHooks } from './hooks/produtos-criar-form-hooks';
...
import { useSetState, useUpdate } from 'react-use';

export function ProdutosCriarForm(): React.JSX.Element {
  ...
  const [updateFlags, setTipoUpdateFlags] = useSetState({
    produto_marca: 0,
    produto_submarca: 0,
    produto_linha: 0,
  ...
  const handleCloseModal = (): void => {
    if (selectedTipo) {
      setTipoUpdateFlags((prev: any) => ({ ...prev, [selectedTipo]: prev[selectedTipo] + 1 }));
                      ...
                      render={({ field }) => (
                        <FormControl error={Boolean(errors.id_Linha)} fullWidth>
                          ...
                          <ButtonGroup fullWidth variant='outlined' size='small' sx={{ mt: 1 }}>
                            <SelectTipos
                              variant='outlined'
                              dsTipo='produto_caracteristica' placeholder="Selecione a Caracteristica"
                              updateFlag={updateFlags.produto_caracteristica} {...field} />
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <FormControl error={Boolean(errors.id_Linha)} fullWidth>
                          ...
                          <ButtonGroup fullWidth variant='outlined' size='small' sx={{ mt: 1 }}>
                            <SelectTipos variant='outlined' dsTipo='produto_tipo' placeholder="Selecione o Tipo" {...field} updateFlag={0} />
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <FormControl error={Boolean(errors.id_Linha)} fullWidth>
                          ...
                          {/* <SelectTipos dsTipo='produto_tipo' placeholder="Selecione o Tipo" {...field} /> */}
