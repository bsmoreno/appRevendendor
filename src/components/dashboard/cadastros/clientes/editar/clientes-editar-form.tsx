...
import { ClientesEditarHooks } from "./hooks/clientes-editar-hooks";
import { Card, CardContent, Button, CardActions, Divider, FormControl, FormHelperText, InputLabel, OutlinedInput, Stack, ToggleButton, Typography, Switch, FormControlLabel } from "@mui/material";
...
export function ClientesEditarForm({ id_Cliente }: ClientesEditarProps): React.JSX.Element {
    var {
        Controller,
        watch,
        handleSubmit,
        ...
        maskCpfCnpj,
        maskTelefone
    } = ClientesEditarHooks(id_Cliente);
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <FormControl error={Boolean(errors.cd_CpfCnpj)} fullWidth>
                                                ...
                                                <FormControlLabel
                                                    control={
                                                        <Switch checked={field.value} {...field} color={field.value ? 'success' : 'error'}  />
                                                    }
