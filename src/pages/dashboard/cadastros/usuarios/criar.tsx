...
import { UsuariosCriarForm } from '@/components/dashboard/cadastros/usuarios/criar/usuarios-criar-form';
...
const metadata = { title: `Criar | Usuários | Dashboard | ${config.site.name}` } satisfies Metadata;
